...
def init_demo_data():
    ...
    if Sale.query.count() == 0:
        ...
        services = ['Underground Water Survey', 'Crop Monitoring', 'Fire Hazard Mapping', 'Land-Use Planning', 'Soil Mapping', 'Soil Analysis', 'Staffing Solutions', 'Crop Advisory', 'Crop Praying', 'Boundary Pegging']
